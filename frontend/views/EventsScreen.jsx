        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <View style={styles.modalContainer}>
              ...
              <Text style={styles.questionText}>What event perks are you interested in?</Text>
                <View style={styles.card2}>
                <ScrollView>
                  {perksList.map((item) => (
                    <TouchableOpacity
              ...
              <TouchableOpacity onPress={handleCloseModal2} style={styles.bottombutton1}>
                <Text style={styles.bottombuttontext1}>
                  Close
                </Text>
              </TouchableOpacity>
          ...
          >
            <View style={styles.modalContainer}>
              ...
              <Text style={styles.questionText}>What event themes are you interested in?</Text>
                <View style={styles.card2}>
                <ScrollView>
                  {themesList.map((item) => (
                    <TouchableOpacity
              ...
              <TouchableOpacity onPress={handleCloseModal3} style={styles.bottombutton1}>
                <Text style={styles.bottombuttontext1}>
                  Close
                </Text>
              </TouchableOpacity>
